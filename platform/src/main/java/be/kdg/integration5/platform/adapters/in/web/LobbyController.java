...
public class LobbyController {
    ...
    public LobbyController(PlayerJoinsLobbyUseCase playerJoinsLobbyUseCase, PlayerCreatesInviteUseCase playerCreatesInviteUseCase, GetOpenLobbiesUseCase getLobbyUseCase) {
